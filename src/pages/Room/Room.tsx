...
export const Room = () => {
  ...
  const handleLikeQuestion = async(questionId: string, likeId: string | undefined) =>{
    //Removendo o like
    if(likeId){
      const likesRef = ref(database, `rooms/${params.id}/questions/${questionId}/likes/${likeId}`);

      await remove(likesRef); 
    }else{
      //Acessando e adicionando um novo like
      const likesRef = ref(database, `rooms/${params.id}/questions/${questionId}/likes`);
